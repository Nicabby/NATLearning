...
export const PROJECTS: Project[] = [
  /* ---------------- eLearning & Digital Binders ---------------- */
  {
    ...
    category: "elearning",
    deliverableType: "eLearning Course",
    ...
    summary:
      "A six-lesson eLearning course preparing supportive adults to work with adolescents through periods of change. Built for a youth-development organization that needed every facilitator working from the same grounding, regardless of prior training, before they ran group sessions with teens.",
    highlights: [
  ...
  },
  {
    ...
    summary:
      "A companion binder that mirrors the eLearning one tab per lesson, then adds what a course module cannot: somewhere to keep notes, reflect, and look up a framework mid-session. It exists because a facilitator mid-session needs a framework in front of them, not buried three clicks into an LMS course player.",
    highlights: [
  ...
  },
  {
    ...
    category: "elearning",
    deliverableType: "Web Application (PWA)",
    attribution: "Youth development organization",
    role: "Instructional designer and developer",
    format: "Progressive web application",
    summary:
      "A digital binder for a facilitator development program, built to feel like paper and behave like software. It became the reference pattern for later binder projects rather than a one-off build. The organization's facilitators needed something they could annotate and search offline, at a kitchen table or on a train, without a laptop or a login.",
    highlights: [
  ...
  },
  {
    ...
    summary:
      "The learner-facing binder for a leadership program built on four elements — Responsibility, Empathy, Accountability and Leading by Example — for supervisors and emerging leaders. Supervisors move between roles and locations often enough that a printed binder gets lost in the handoff; this one travels with the person, not the desk.",
    highlights: [
  ...
  },
  {
    ...
    category: "elearning",
    deliverableType: "PDF Resource",
    attribution: "Youth development organization",
    role: "Instructional designer and developer",
    format: "Web guide with a generated PDF edition",
    summary:
      "A fully scripted facilitation guide for four 90-minute live virtual sessions, published as both a website and a print edition generated from that same site. The client wanted a guide detailed enough that a facilitator who did not design the program could still run it with confidence on the first try.",
    highlights: [
  ...
  /* ---------------- AI Resources for Educators ---------------- */
  {
    ...
    summary:
      "An eight-stage planning process that places a teacher decision before, during and after every AI interaction — from naming the learning goal through to verifying and owning the final plan. It was written for teachers who wanted to use AI for planning but had no structured way to know when to trust its output and when to override it.",
    highlights: [
  ...
  },
  {
    ...
    summary:
      "The first half of the planning process: clarify the learning goal, describe learners and context safely, and generate activity options worth choosing between. Aimed at the moment before a teacher opens an AI tool, when a vague prompt produces a vague lesson.",
    highlights: [
  ...
  },
  {
    ...
    summary:
      "The second half: turning promising AI output into a lesson that is actually aligned, accessible and assessable. Answers the question that follows a good first draft: is this actually teachable, to this class, against this curriculum expectation.",
    highlights: [
  ...
  },
  {
    ...
    summary:
      "A structured way for teachers, instructional coaches and older students to review what an AI system produced before anyone relies on it. Built so the review takes minutes for a low-stakes draft and a full pass only when the output will actually reach students.",
    highlights: [
  ...
  },
  {
    ...
    summary:
      "The CHECK process — Clarify, Highlight, Examine, Confirm, then Keep, change or discard — practised against fictional AI outputs before it is used on real ones. Gives a team a shared vocabulary for the review conversation, instead of everyone applying a different, unstated bar.",
    highlights: [
  ...
  },
  {
    ...
    summary:
      "Sixteen scenarios that give a class a way to argue about where help ends and cheating begins, rather than being handed a rule. Designed for the classroom discussion a single-sentence AI policy can never actually settle.",
    highlights: [
  ...
  },
  {
    ...
    summary:
      "Agreement templates, disclosure tools and family communication for classrooms establishing how AI may be used — and making clear that permission can change by assignment. Written for the teacher fielding the same question from twenty-eight students and their families, in slightly different words each time.",
    highlights: [
  ...
  },
  {
    ...
    summary:
      "Three lessons introducing how generative AI works, written so that no student needs an account to take part. Built for schools where account-based AI tools are blocked, restricted, or simply not something a teacher wants to navigate mid-lesson.",
    highlights: [
  ...
  },
  {
    ...
    summary:
      "The companion unit: scenarios about responsible use, a final assessment with a rubric, and a closing reflection. Pairs with the foundations unit so a school can run both as a single short course without sourcing a second resource.",
    highlights: [
  ...
  },
  {
    ...
    category: "ai-resources",
    deliverableType: "Facilitation Guide",
    attribution: "NATLearning (self-published)",
    role: "Author and facilitator",
    format: "75-minute PD session · 12-slide outline · 60+ prompts",
    summary:
      "A ready-to-run professional learning session on the premise that reflection is only useful when it changes what a learner notices or does next. Built for a staff meeting or PLC lead who has forty-five minutes, not a semester, to shift how their team uses reflection prompts.",
    highlights: [
  ...
  },
  {
    ...
    summary:
      "A barrier-first approach: start from one shared goal, find where access actually breaks down, and make the smallest useful adjustment. Written for the teacher who does not have prep time for three parallel lesson plans and should not need it.",
    highlights: [
  ...
  },
  {
    ...
    summary:
      "A Notice / Wonder / Choose framework for treating emotions as information worth reading rather than behaviour to manage. Built for classrooms where the current approach treats a dysregulated moment as a discipline problem instead of a signal.",
    highlights: [
  ...
  },
  {
    ...
    summary:
      "Structure that belongs to the process rather than the product: shared checkpoints and quality expectations, without requiring every learner to produce the same thing. Gives a teacher running open-ended inquiry a way to grade the thinking consistently, even when every student's final product looks different.",
    highlights: [
  ...
  /* ---------------- Corporate L&D & LMS ---------------- */
  {
    slug: "enterprise-lms",
    category: "corporate",
    deliverableType: "LMS Platform Build",
    ...
    summary:
      "Leading the redesign, build and launch of a corporate learning platform serving multiple business units. The prior platform had grown business unit by business unit with no shared architecture; this rebuild gives every team a learning path structure that reports the same way.",
    highlights: [
  ...
  },
  {
    ...
    category: "corporate",
    deliverableType: "Analysis Report",
    ...
    summary:
      "Change impact documentation across two procurement verticals — Contracts and Sourcing, and Procure-to-Pay — tracing process changes through to the training materials they affect. Commissioned so the L&D team could stop retraining every process touched by a change and start retraining only the ones the change actually affected.",
    highlights: [
  ...
  },
  {
    ...
    category: "corporate",
    deliverableType: "Storyboard Documentation",
    attribution: "Luxury retail brand",
    role: "Instructional designer",
    format: "Development-ready storyboard documentation",
    summary:
      "Structured storyboards for a luxury sales training program — the handoff artifact that lets a developer build without guessing at intent. Written so a development team could build the course without a round trip back to the designer to ask what a screen was supposed to do.",
    highlights: [
  ...
  /* ---------------- K–12 Curriculum & Apps ---------------- */
  {
    ...
    summary:
      "A curriculum-aligned financial literacy application for Ontario Grade 4, pairing interactive lessons with a working family expense tracker. Built to answer a specific gap: Grade 4 financial literacy expectations exist in the curriculum, but very few tools let a student practise the actual behaviour, not just read about it.",
    highlights: [
  ...
  },
  {
    ...
    category: "k12",
    deliverableType: "Diagnostic Assessment",
    attribution: "Independent project",
    role: "Assessment designer",
    format: "Adaptive diagnostic assessment, H5P implementation",
    summary:
      "An adaptive diagnostic aligned to Ontario Curriculum Strand B, tiered so that a teacher learns where a student actually is rather than only whether they passed. Designed for the planning meeting after testing, where 'below grade level' is not specific enough to plan the next lesson from.",
    highlights: [
  ...
  },
  {
    ...
    summary:
      "A tiered diagnostic series spanning the full Life Systems strand, designed to locate where a gap begins rather than confirm that one exists. Built as a series rather than a one-off, so a school can track the same strand's gaps consistently from Grade 1 through Grade 8.",
    highlights: [
